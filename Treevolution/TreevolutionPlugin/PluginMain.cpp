...
MStatus initializePlugin(MObject obj)
{
    ...
    MGlobal::executeCommand("string $menu = `menu -label \"Create L-System\" -parent $gMainWindow`;");
    MGlobal::executeCommand("menuItem -label \"Create L-System\" -c guiScript;");
    MGlobal::executeCommand("menuItem -label \"Create L-System Node\" -c nodeScript;");*/
